...
void wifi_remote_init() {
  ...
  // CBA-patch: WiFi-creds uit node_config.h (overschrijfbaar via flash-node.sh)
  #include "node_config.h"
  strncpy(wr_ssid, NODE_WIFI_SSID, 32); wr_ssid[32] = 0x00;
  strncpy(wr_psk,  NODE_WIFI_PSK,  32); wr_psk[32]  = 0x00;
