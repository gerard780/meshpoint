 ...
 * (a stringified raw enum int, e.g. "70"): node_drawer.js Node Info,
 * node_cards.js chips, and stats_tab.js hardware distribution chart.
 * Loaded once early as a plain global (matches non-module script style).
 */
const HW_NAMES = {
    0: 'UNSET',
