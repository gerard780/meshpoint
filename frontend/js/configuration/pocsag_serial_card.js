 ...
 *
 * The "Companion firmware" compile/flash card used to live here too; it
 * moved to the standalone Configuration → Firmware page
 * (frontend/js/configuration/pocsag_firmware_card.js) for the same
 * reason the MeshCore/Meshtastic ones did: flashing reads as its own
 * action, not settings for an already-assigned companion.
 */
