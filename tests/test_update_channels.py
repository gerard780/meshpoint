...
class TestReleaseChannelRegistry(unittest.TestCase):
    ...
    def test_find_returns_rc_channel(self) -> None:
        match = ReleaseChannelRegistry().find("rc-079")
        self.assertIsNotNone(match)
        self.assertEqual(match.tier, "rc")
        self.assertEqual(match.branch, "feat/v0.7.9")
    ...
    def test_normalize_channel_id_remaps_retired_rc(self) -> None:
        self.assertEqual(normalize_channel_id("rc-074"), "rc-079")
        self.assertEqual(normalize_channel_id("rc-075"), "rc-079")
        self.assertEqual(normalize_channel_id("rc-076"), "rc-079")
        self.assertEqual(normalize_channel_id("rc-077"), "rc-079")
        self.assertEqual(normalize_channel_id("rc-078"), "rc-079")
